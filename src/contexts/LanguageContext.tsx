...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'about.nameIntro': 'Antes de contarte sobre Lumar Camping, necesitas conocer a Luis Lugo Mármol, mi padre.',
    'about.nameStory': 'Lugo + Mármol = Lumar.\n\nMi papá no tenía mucho dinero, pero cada fin de semana empacaba a nuestra familia y nos llevaba a espacios salvajes donde los únicos sonidos eran el viento entre los árboles y las fogatas crepitantes. Creía que el mejor salón de clases estaba al aire libre, que la naturaleza sana todo.\n\nEsos viajes de acampada no eran vacaciones. Fueron donde aprendí quién era. Mi padre ya no está, pero esos recuerdos formaron todo en lo que me convertí.',
    'about.beginningTitle': 'Cómo Llegamos Aquí',
    'about.beginning2017': 'En 2017, Eduardo y yo comenzamos a llevar a nuestros propios hijos a acampar, una vez al año al principio, intentando recrear lo que mi padre me dio. Algo mágico sucedió. Nuestros hijos dejaron sus teléfonos. Hablamos. Reímos. Recordamos cómo se siente ser una familia.',
    'about.beginning2021': 'Para 2021, estábamos acampando todos los meses, a veces dos veces. No podíamos tener suficiente.',
    'about.beginning2024': 'A finales de 2024, nos dimos cuenta: ¿Qué tal si pudiéramos dar esto a otras familias? ¿Qué tal si lo hiciéramos tan fácil que cualquier padre pudiera decir sí a la aventura?',
    'about.missionTitle': 'Por Qué Hacemos Esto',
    'about.mission1': 'Cada familia nos dice lo mismo: "Esto era exactamente lo que necesitábamos. Nunca habríamos hecho esto solos."',
    'about.mission2': 'Los padres lloran viendo a sus adolescentes explorar arroyos. Los niños preguntan: "¿Podemos hacer esto todos los meses?"',
    'about.mission3': 'Mi padre creía que el tiempo en la naturaleza hace mejores humanos, más amables, más valientes, más conectados. Después de nuestro primer año, sabemos que tenía razón.',
    'about.differenceTitle': '',
    'about.difference1': 'Esto no es solo un negocio de renta. Este es trabajo de legado. Personalmente saludo a cada familia. Enseño a los niños a encender fogatas como mi papá me enseñó. Ayudo a los primerizos nerviosos a relajarse. Y cuando veo a padres enseñando a sus hijos a apreciar la naturaleza, veo a mi papá en cada uno de ellos.',
    'about.difference2': '',
    'about.dreamTitle': 'El Sueño',
    'about.dream1': 'Mi padre no pudo conocer a todos sus nietos. Pero a través de Lumar, su espíritu está acampando con familias en todo Texas. Su creencia de que "la naturaleza sana todo" está tocando a niños que crecerán y llevarán a sus propios hijos a acampar.',
    'about.dream2': 'Eso no es solo crecimiento. Eso es impacto generacional.\n\nUna familia. Una fogata. Un recuerdo a la vez.',
