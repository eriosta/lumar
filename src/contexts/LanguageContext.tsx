...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.nameStory': 'Lugo + Mármol = Lumar.\n\nMy dad believed the best classroom was outdoors. Growing up in Venezuela, he would pack up our family and take us camping at the beach. Not to fancy resorts, but to wild stretches of coastline where you could hear nothing but ocean waves.\n\nHe didn\'t have much money, but he had what mattered: time, a sense of adventure, and a belief that nature has a way of grounding us. Those beach camping trips shaped who we became. My siblings and I bonded there. My dad showed us that life\'s best moments often come from simple things. Sand between your toes, waves at night, a fire to gather around.\n\nMy father passed away, but those memories stayed with me.',
    'about.griefTitle': 'The Mission',
    'about.griefStory': 'When Eduardo and I had our own children, we wanted to give them similar experiences. But we noticed something: many families want to go camping but find the barriers too high.\n\nThe gear is expensive. The logistics are overwhelming. Busy parents don\'t know where to start. So they don\'t, and miss out on something valuable.\n\nWe knew from experience that camping doesn\'t have to be complicated. A tent, a cooler, and enthusiasm can go a long way.\n\nThat\'s when we realized: we could help other families get started.',
    ...
    'about.difference1': 'This isn\'t just a rental business. It\'s personal.\n\nWe greet every family ourselves. We teach kids how to start a campfire. We help first-time campers feel at ease.\n\nWhat sets us apart is experience. Eduardo and I built our family around outdoor adventures. We know what makes camping enjoyable versus frustrating. We\'ve made the mistakes so you don\'t have to.\n\nTime in nature makes us better: more present, more grounded. After a year of doing this, we\'ve seen that play out with every family we host.',
    'about.whyMattersTitle': 'Why "Lumar" Matters',
    'about.whyMattersStory': 'Every trip we host carries my father\'s name and values.\n\nWhen families join us, they\'re choosing:\n\nAdventure over routine\n\nConnection over convenience\n\nTime outdoors over time on screens\n\nLuis Lugo Mármol loved the outdoors and loved sharing it with his family. Lumar Camping carries that forward: his initials, his approach, now reaching families across Texas.',
    'about.dreamTitle': 'Looking Ahead',
    'about.dream1': 'My father didn\'t get to meet all his grandchildren. But through this business, his love for the outdoors lives on.',
    'about.dream2': 'This is about more than camping. It\'s about helping families slow down, disconnect, and experience something real together.\n\nWe\'ve validated the concept in our first year. Now we\'re growing, from 8 families per month to 8 families every other weekend, scaling from around 100 families per year toward 200+.\n\nThat\'s the vision: one family, one campfire, one trip at a time.',
  ...
  es: {
    ...
    'about.nameStory': 'Lugo + Mármol = Lumar.\n\nMi papá creía que el mejor salón de clases estaba al aire libre. Creciendo en Venezuela, empacaba a nuestra familia y nos llevaba a acampar en la playa. No a resorts lujosos, sino a tramos salvajes de costa donde solo se escuchaban las olas del océano.\n\nNo tenía mucho dinero, pero tenía lo que importaba: tiempo, sentido de aventura y la creencia de que la naturaleza nos conecta a tierra. Esos viajes de acampada en la playa nos formaron. Mis hermanos y yo nos unimos allí. Mi papá nos mostró que los mejores momentos de la vida vienen de cosas simples. Arena entre los dedos, olas de noche, una fogata para reunirse.\n\nMi padre falleció, pero esos recuerdos permanecen conmigo.',
    'about.griefTitle': 'La Misión',
    'about.griefStory': 'Cuando Eduardo y yo tuvimos nuestros propios hijos, queríamos darles experiencias similares. Pero notamos algo: muchas familias quieren acampar pero encuentran las barreras muy altas.\n\nEl equipo es costoso. La logística es abrumadora. Los padres ocupados no saben por dónde empezar. Entonces no lo hacen, y se pierden algo valioso.\n\nSabíamos por experiencia que acampar no tiene que ser complicado. Una carpa, una hielera y entusiasmo pueden llevarte lejos.\n\nFue entonces cuando nos dimos cuenta: podíamos ayudar a otras familias a comenzar.',
    ...
    'about.difference1': 'Esto no es solo un negocio de renta. Es personal.\n\nSaludamos a cada familia nosotros mismos. Enseñamos a los niños cómo encender una fogata. Ayudamos a los campistas primerizos a sentirse cómodos.\n\nLo que nos distingue es la experiencia. Eduardo y yo construimos nuestra familia alrededor de aventuras al aire libre. Sabemos qué hace el camping agradable versus frustrante. Hemos cometido los errores para que tú no tengas que hacerlo.\n\nEl tiempo en la naturaleza nos hace mejores: más presentes, más conectados. Después de un año haciendo esto, lo hemos visto en cada familia que recibimos.',
    'about.whyMattersTitle': 'Por Qué "Lumar" Importa',
    'about.whyMattersStory': 'Cada viaje que organizamos lleva el nombre y los valores de mi padre.\n\nCuando las familias se unen a nosotros, están eligiendo:\n\nAventura sobre rutina\n\nConexión sobre conveniencia\n\nTiempo al aire libre sobre tiempo en pantallas\n\nLuis Lugo Mármol amaba el aire libre y amaba compartirlo con su familia. Lumar Camping lleva eso adelante: sus iniciales, su enfoque, ahora llegando a familias en todo Texas.',
    'about.dreamTitle': 'Mirando Adelante',
    'about.dream1': 'Mi padre no pudo conocer a todos sus nietos. Pero a través de este negocio, su amor por el aire libre sigue vivo.',
    'about.dream2': 'Esto es más que camping. Es ayudar a las familias a desacelerar, desconectarse y experimentar algo real juntos.\n\nHemos validado el concepto en nuestro primer año. Ahora estamos creciendo, de 8 familias por mes a 8 familias cada dos fines de semana, escalando de alrededor de 100 familias por año hacia más de 200.\n\nEsa es la visión: una familia, una fogata, un viaje a la vez.',
