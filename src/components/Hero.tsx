    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="inline-flex items-center gap-3 bg-sunset hover:bg-sunset-light text-white px-10 py-4 text-lg font-semibold rounded-full transition-all shadow-lg hover:shadow-xl"
        >
