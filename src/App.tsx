  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="py-20 px-4 sm:px-5 bg-gradient-to-br from-forest to-forest-light text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-50px" }}
            transition={{ delay: isMobile ? 0 : 0.1, duration: isMobile ? 0.3 : 0.5 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {[
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-50px" }}
                transition={{ delay: isMobile ? 0 : index * 0.1, duration: isMobile ? 0.3 : 0.5 }}
                className="text-center group"
              >
                <div className="w-20 h-20 mx-auto mb-6 text-sand/80 md:group-hover:text-sand transition-colors">
                  {item.icon}
                </div>
      ...
      <section id="booking" className="py-20 md:py-28 px-4 sm:px-5 bg-white pb-24 md:pb-28">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="mt-10 md:mt-12 bg-sand-light p-6 md:p-8 rounded-2xl">
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 md:py-16 px-4 sm:px-5 pb-24 md:pb-16">
        <div className="max-w-7xl mx-auto text-center">
          {/* Logo */}
          <div className="mb-12 px-4 flex justify-center items-center">
            <img
              src={logoImage}
              alt="Lumar Camping Experience Logo"
              className="w-full max-w-md md:max-w-lg lg:max-w-xl h-auto object-contain opacity-90"
            />
          </div>
